...
try:
    ...
    from plugins.FabCovid19.visualisation.DataAggregator import facs_combine, facs_compare, facs_uk_validation_nw, facs_uk_validation_se, facs_uk_combined_plotter, facs_uk_county_plotter, facs_uk_compare_measures
